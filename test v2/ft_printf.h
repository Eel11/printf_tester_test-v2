...
/*   Updated: 2019/11/30 18:13:27 by htagrour         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
typedef int (*print_func)(const char *fmt, va_list list, t_flags flags,int len);
int     ft_printf(const char *format, ...);
...
int     ft_num_cases(unsigned long long nbr, unsigned int base, const char *base_char);
...
int     ft_print_b_0(int nb, char c);
